...
export const headerVariants = cva(
  [
    "flex justify-center items-center fixed z-10 h-[var(--header-h)] p-2.5",
    ...
    variants: {
      state: {
        ...
        shrunken: [
          ...
          "left-[calc(50vw-486px)] right-[calc(50vw-486px)] min-w-[500px] max-[1024px]:left-1/10 max-[1024px]:right-1/10",
        ],
      },
    },
    defaultVariants: {
